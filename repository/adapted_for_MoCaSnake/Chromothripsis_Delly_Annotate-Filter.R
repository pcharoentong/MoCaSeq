...
option_list = list(
  ...
  make_option(c("-N", "--normal"),type="character",default=NULL,help="name of normal column"),
  make_option(c("-T", "--tumor"),type="character",default=NULL,help="name of tumor column"),
...
if (is.null(opt$normal)) stop("Need --normal")
if (is.null(opt$tumor)) stop("Need --tumor")
...
setnames(inputDT, paste("GEN[",opt$normal,"].DR",sep=""), "control.DR")
setnames(inputDT, paste("GEN[",opt$normal,"].DV",sep=""), "control.DV")
setnames(inputDT, paste("GEN[",opt$normal,"].RR",sep=""), "control.RR")
setnames(inputDT, paste("GEN[",opt$normal,"].RV",sep=""), "control.RV")
setnames(inputDT, paste("GEN[",opt$tumor,"].DR",sep=""), "tumor.DR")
setnames(inputDT, paste("GEN[",opt$tumor,"].DV",sep=""), "tumor.DV")
setnames(inputDT, paste("GEN[",opt$tumor,"].RR",sep=""), "tumor.RR")
setnames(inputDT, paste("GEN[",opt$tumor,"].RV",sep=""), "tumor.RV")
